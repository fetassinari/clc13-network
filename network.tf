...
## Associa a rt priv-rt-1a com a subnet privada priv-subnet-1b 
...
resource "aws_flow_log" "example" {
  log_destination      = "arn:aws:s3:::fernando-tassinari-clc13-network-terraform-state"
